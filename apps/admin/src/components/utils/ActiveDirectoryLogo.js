export default function ActiveDirectoryLogo({ ...props }) {
    return (
        <svg
            viewBox="0 0 256 256"
        ...
        >
            <defs>
                <linearGradient
                    id="azure_ab40b385-f958-420f-bfab-714be1677426-01a65295"
                    x1="-960.606"
                    y1="283.397"
                    x2="-1032.511"
                    y2="70.972"
                ...
                <linearGradient
                    id="azure_f40af90d-72eb-49b3-94b2-2510f1071722-c7b6ab07"
                    x1="-938.144"
                    y1="184.402"
                    x2="-954.778"
                    y2="178.778"
                ...
                <linearGradient
                    id="azure_e382d742-7d51-4974-a256-24e182eef053-97639097"
                    x1="-947.292"
                    y1="289.594"
                    x2="-868.363"
                    y2="79.308"
            ...
            <path
                ...
                fill="url(#azure_ab40b385-f958-420f-bfab-714be1677426-01a65295)"
            ></path>
            <path
            ...
            <path
                ...
                fill="url(#azure_f40af90d-72eb-49b3-94b2-2510f1071722-c7b6ab07)"
            ></path>
            <path
                ...
                fill="url(#azure_e382d742-7d51-4974-a256-24e182eef053-97639097)"
            ></path>
        </svg>
    )
}
